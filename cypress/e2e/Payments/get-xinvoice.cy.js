...
const invoicesUrl ='/payments/invoices'
let subscriptionId = '';

describe('Get Invoice For Created Subscription Tests', ()=> {
    ...
    it('Should Return a List of Available Invoices', ()=> {
        cy.request({
            method: 'GET',
            url: invoicesUrl + "?" + "projectId=1",
            headers: {
                Authorization: 'Bearer ' + sessionToken,
                accept: 'application/json' 
            },
